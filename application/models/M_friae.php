   ...
   public function crear_friae($datos){
    ...
    public function id_friae($id_grupo){
     ...
     function nombre_materias_friae($grupo){
        return $this->db->query("select id_materia,unidad_contenido from Grupo_Estudiante ge inner join Materia m on ge.id_materia=m.clave where Grupo_id_grupo='".$grupo."' group by id_materia")->result()[0];
    }
