            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-label-group">
                    ...
                    <input list="secundarias" required="required" class="form-control" id="aspirante_secundaria_cct" name="aspirante_secundaria_cct" placeholder="Buscar secundaria por CCT">
