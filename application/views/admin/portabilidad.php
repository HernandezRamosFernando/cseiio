    ...
    <form id="formulario">
        ...
        <div class="row">
          <div class="col-md-4">
            <label class="form-group has-float-label">
              <select class="form-control form-control-lg" id="aspirante_sexo"  name="aspirante_sexo">
      ...
      <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-8">
            <label class="form-group has-float-label">
              <select class="form-control form-control-lg" id="aspirante_plantel"  name="aspirante_plantel">
          ...
          <div class="col-md-4">
            <label class="form-group has-float-label">
              <select class="form-control form-control-lg" id="aspirante_semestre" name="aspirante_semestre">
      ...
      <div class="form-group">
        <div class="row">
          <div class="col-md-4">
            <label class="form-group has-float-label">
              <select class="form-control form-control-lg"   name="aspirante_nacimiento_estado" onChange="curp();"
                id="selector_estado_nacimiento_aspirante">
          ...
          <div class="col-md-4">
            <div class="form-label-group">
              <input type="text" pattern="[A-Za-z0-9]{18}" title="Datos incorrectos"  class="form-control text-uppercase"
                id="aspirante_curp" name="aspirante_curp" placeholder="CURP">
          ...
          <div class="col-md-4">
            <div class="form-label-group">
              <input type="text" title="Datos incorrectos" class="form-control text-uppercase"
                id="aspirante_lugar_nacimiento" name="aspirante_lugar_nacimiento"   placeholder="Lugar de nacimiento">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <label class="form-group has-float-label" style="font-weight:bold">
              <select class="form-control form-control-lg"  name="aspirante_direccion_estado"
          ...
          <div class="col-md-4">
            <label class="form-group has-float-label" style="font-weight:bold">
              <select class="form-control form-control-lg"   name="aspirante_direccion_municipio"
          ...
          <div class="col-md-4">
            <label class="form-group has-float-label"  style="font-weight:bold">
              <select class="form-control form-control-lg"   name="aspirante_direccion_localidad"
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-2">
              <label class="form-group has-float-label">
                <select class="form-control" onchange="lenguas_evento(this)"  id="aspirante_lengua_nombre"
        ...
        <div class="form-check">
          <label class="form-check-label">
            <input type="checkbox" class="form-check-input" name="aspirante_documento_certificado_parcial"
              id="aspirante_documento_certificado_parcial" value="4" unchecked>
        ...
        <div class="form-check">
          <label class="form-check-label">
            <input type="checkbox" class="form-check-input" name="aspirante_documento_resolucion"
              id="aspirante_documento_resolucion" value="4" unchecked>
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-4">
              <div class="form-label-group">
                <input type="text" pattern="[A-Za-z0-9]+[ ]*[A-Za-z0-9]*" onchange="valida(this)" 
                  title="El nombre de la secundaria contiene caracteres incorrectos" class="form-control text-uppercase"
            ...
            <div class="col-md-4">
              <div class="form-label-group">
                <input type="text" ppattern="[A-Za-z0-9]+[ ]*[A-Za-z0-9]*" onchange="valida(this)" 
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <label class="form-group has-float-label">
                <select class="form-control form-control-lg"  name="aspirante_secundaria_estado"
            ...
            <div class="col-md-4">
              <label class="form-group has-float-label">
                <select class="form-control form-control-lg"  name="aspirante_secundaria_municipio"
            ...
            <div class="col-md-4">
              <label class="form-group has-float-label">
                <select class="form-control form-control-lg"  name="aspirante_secundaria_localidad"
