    ...
    <form id="formulario">
          ...
          <div class="col-md-4">
            <div class="form-label-group">
              <input type="text" pattern="[A-Za-z]+[ ]*[A-Za-z ]*" required title="Introduzca solo letras validas"
                ...
                onchange="valida(this)" placeholder="Nombre(s)">
      ...
      <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="col-md-4 text-center">
            <div class="form-label-group">
              <input type="date" required class="form-control text-uppercase" max="2006-01-01"
                title="La edad minima para ingresar es 14 años" id="aspirante_fecha_nacimiento"
        ...
        <div class="row">
          <div class="col-md-4">
            <label class="form-group has-float-label">
              <select class="form-control form-control-lg" id="aspirante_sexo" required name="aspirante_sexo">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label class="form-group has-float-label">
                <select class="form-control form-control-lg" name="tipo_sangre" required id="tipo_sangre">
          ...
          <div class="col-md-4">
            <label class="form-group has-float-label">
              <select class="form-control form-control-lg" id="aspirante_alergia_combo" name="aspirante_alergia_combo"
      ...
      <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-8">
            <label class="form-group has-float-label">
              <select class="form-control form-control-lg" id="aspirante_plantel" required name="aspirante_plantel">
          ...
          <div class="col-md-4">
            <label class="form-group has-float-label">
              <select class="form-control form-control-lg" required id="aspirante_semestre" name="aspirante_semestre"
                required>
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-label-group">
              <input type="text" pattern="[A-Za-z0-9]{18}" title="Datos incorrectos" required
                class="form-control text-uppercase" id="aspirante_curp" name="aspirante_curp" placeholder="CURP">
          ...
          <div class="col-md-3 text-center">
            <div class="form-label-group">
              <input type="date" class="form-control text-uppercase" max="2006-01-01"
                ...
                placeholder="Fecha de registro de NRcimiento">
      ...
      <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-label-group">
              <input type="text" pattern="[A-Za-z0-9]+[ ]*[A-Za-z0-9]*"
                title="La direccion tiene caracteres incorrectos" required class="form-control text-uppercase"
                id="aspirante_direccion_calle" name="aspirante_direccion_calle" onchange="valida(this)"
          ...
          <div class="col-md-4">
            <div class="form-label-group">
              <input type="text" pattern="[A-Za-z0-9]+[ ]*[A-Za-z0-9]*" title="La colonia tiene caracteres incorrectos"
                class="form-control text-uppercase" onchange="valida(this)" id="aspirante_direccion_colonia"
                name="aspirante_direccion_colonia" placeholder="Colonia">
          ...
          <div class="col-md-4">
            <div class="form-label-group">
              <input type="text" pattern="[A-Za-z]+[ ]*[A-Za-z ]*" onchange="valida(this)" required
                ...
                name="aspirante_tutor_apellido" placeholder="Nombre Completo">
      ...
      <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="form-label-group">
                <input type="text" pattern="[A-Za-z]+[ ]*[A-Za-z ]*" onchange="valida(this)"
                  ...
                  name="aspirante_tutor_ocupacion" placeholder="Ocupación">
        ...
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-2">
              <label class="form-group has-float-label">
                <select class="form-control" onchange="lenguas_evento(this)" required id="aspirante_lengua_nombre"
            ...
            <div class="col-md-2">
              <label class="form-group has-float-label">
                <select class="form-control"="" id="aspirante_lengua_lee" name="aspirante_lengua_lee" disabled>
            ...
            <div class="col-md-2">
              <label class="form-group has-float-label">
                <select class="form-control"="" id="aspirante_lengua_habla" name="aspirante_lengua_habla" disabled>
                  <option value="0">Nada 0%</option>
                  <option value="25">Poco 25%</option>
                  <option value="50">Regular 50%</option>
                  <option value="100">Bien 100%</option>
            ...
            <div class="col-md-2">
              <label class="form-group has-float-label">
                <select class="form-control"="" id="aspirante_lengua_escribe" name="aspirante_lengua_escribe" disabled>
                  <option value="0">Nada 0%</option>
                  <option value="25">Poco 25%</option>
                  <option value="50">Regular 50%</option>
                  <option value="100">Bien 100%</option>
            ...
            <div class="col-md-2">
              <label class="form-group has-float-label">
                <select class="form-control"="" id="aspirante_lengua_entiende" name="aspirante_lengua_entiende"
                  disabled>
                  <option value="0">Nada 0%</option>
                  <option value="25">Poco 25%</option>
                  <option value="50">Regular 50%</option>
            ...
            <div class="col-md-2">
              <label class="form-group has-float-label">
                <select class="form-control"="" id="aspirante_lengua_traduce" name="aspirante_lengua_traduce" disabled>
                  <option value="0">Nada 0%</option>
                  <option value="25">Poco 25%</option>
                  <option value="50">Regular 50%</option>
                  <option value="100">Bien 100%</option>
        ...
        <div class="form-check">
          <label class="form-check-label">
            ...
            Certificado parcial de Escuela de Procedencia
          </label>
        </div>
        <div class="form-check">
          <label class="form-check-label">
            <input type="checkbox" class="form-check-input" name="aspirante_documento_resolucion_equivalencia"
              id="aspirante_documento_resolucion_equivalencia" value="6" unchecked>
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-4">
              <div class="form-label-group">
                <input type="text" pattern="[A-Za-z0-9]+[ ]*[A-Za-z0-9]*" onchange="valida(this)" required
                  title="El nombre de la secundaria contiene caracteres incorrectos" class="form-control text-uppercase"
            ...
            <div class="col-md-4">
              <div class="form-label-group">
                <input type="text" ppattern="[A-Za-z0-9]+[ ]*[A-Za-z0-9]*" onchange="valida(this)" required
            ...
            <div class="col-md-4">
              <label class="form-group has-float-label">
                <select class="form-control form-control-lg" name="aspirante_nuevasecundaria_tipo_subsistema" required
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <label class="form-group has-float-label">
                <select class="form-control form-control-lg" required name="aspirante_secundaria_municipio"
            ...
            <div class="col-md-4">
              <label class="form-group has-float-label">
                <select class="form-control form-control-lg" required name="aspirante_secundaria_localidad"
