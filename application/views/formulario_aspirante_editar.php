      ...
      <!--datos personales------------------------------------------------------>
       ...
       <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
            <div class="form-label-group">
            <input type="text" pattern="[a-zA-Z0-9]+" title="La colonia tiene caracteres incorrectos" class="form-control" id="aspirante_direccion_colonia" name="aspirante_direccion_colonia" placeholder="Colonia">
...
<script src="http://192.168.1.115/app/assets/vendor/jquery/jquery.min.js"></script>
    ...
    function cargar_datos(){
      /*
      var no_control = String(window.location).split("/");
      no_control = no_control[no_control.length-1];

            var xhr = new XMLHttpRequest();
            xhr.open('GET', 'http://localhost/app/c_aspirante/get_datos_aspirante/'+no_control, true);

            xhr.onload = function () {
              console.log(JSON.parse(xhr.response));
              var datos = JSON.parse(xhr.response);
              //console.log(datos.aspirante[0].nombre);
