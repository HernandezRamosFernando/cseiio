  ...
  <nav class="navbar navbar-expand navbar-dark static-top" style="background:#545555">
    ...
    <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
      <ul class="navbar-nav ml-auto ml-md-0">
        ...
        <li class="nav-item ">
          <a class="nav-link d-flex justify-content-center align-content-between" href="#"  data-toggle="modal" data-target="#logoutModal" id="userDropdown" role="button" ">
            <i style="color: #F83D3D;"class="material-icons">cancel_presentation</i>
            <i>Cerrar sesión</i>
          </a>
        </li>
      </ul>
