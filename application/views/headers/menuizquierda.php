  ...
  <ul class="sidebar navbar-nav toggled ">
    ...
    <li class="nav-item dropdown ">
      ...
      <div id="submenu" class="<?php ($this->uri->segment(2)=='nuevo_ingreso'||$this->uri->segment(2)=='portabilidad'||$this->uri->segment(2)=='asignar_matricula'||$this->uri->segment(2)=='carta_compromiso') ? print 'null' : print 'collapse'; ?> sidebar-submenu">
        <a class="nav-link <?php ($this->uri->segment(2)=='nuevo_ingreso') ? print 'bg-info text-light' : print null; ?>" href="/cseiio/index.php/c_aspirante/nuevo_ingreso">
        <i class="material-icons">person_add</i>
          <span class="font-weight-light">Inscripción Nuevo Ingreso
          </span>
        </a>
        <a class="nav-link  <?php ($this->uri->segment(2)=='portabilidad') ? print 'bg-info text-light' : print null; ?>" href="/cseiio/index.php/c_aspirante/portabilidad">
        <i class="material-icons">person_outline</i>
          <span class="font-weight-light">Inscripción Portabilidad
          </span>
        </a>
        <a class="nav-link  <?php ($this->uri->segment(2)=='asignar_matricula') ? print 'bg-info text-light' : print null; ?>" href="/cseiio/index.php/c_aspirante/asignar_matricula">
        <i class="material-icons">assignment_turned_in</i>
          <span class="font-weight-light">Asignar Matrícula</span>
        </a>
        <a class="nav-link   <?php ($this->uri->segment(2)=='carta_compromiso') ? print 'bg-info text-light' : print null; ?>" href="/cseiio/index.php/c_aspirante/carta_compromiso">
