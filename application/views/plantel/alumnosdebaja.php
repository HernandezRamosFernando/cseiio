  ...
  <div class="container-fluid ">
    ...
    <div class="col-md-12" id="agregar_oculto" style="display: none">
      <button type="button" value="nuevo" onclick="guardar()" id="boton_agregar"
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Busque al alumno para editar fecha de baja</li>
        </ol>
    ...
    <div class="card" style="overflow:scroll; display:none" id="busqueda_oculto">
      <div class="card-body">
        ...
        </div><!-- cerrar permisos fecha de editar baja -->
...
function buscar() {
      ...
      xhr.open('GET', '<?php echo base_url();?>index.php/c_bajas/busqueda_alumnos_grupo_baja_permisos?' + query, true);
      xhr.onloadstart = function () {
        $('#div_carga').show();
      }
      xhr.error = function () {
