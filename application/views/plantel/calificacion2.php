...
<input type='hidden' value='' name="grupo_seleccionado" id="grupo_seleccionado"/>
        <div class="form-group">
          <div class="row">
      ...
      <button type="submit" value="nuevo" onclick="" id="boton_agregar"
...
<script>
  ...
  var form = document.getElementById("formulario");
	form.onsubmit = function(e){
      ...
      if (result.value) {
		...
		xhr.open("POST","<?php echo base_url();?>index.php/C_grupo_estudiante/agregar_calificaciones_materia_grupo2",true);
  ...
  function validarcomponente() {
    ...
    if (document.getElementById("plantel").value != '' && document.getElementById("grupos").value != '' && document.getElementById("semestre_grupo").value != '' && document.getElementById("materias").value != '') {
        ...
        document.getElementById("grupo_seleccionado").value=document.getElementById("grupos").value;
      ...
      xhr.onload = function () {
        ...
        JSON.parse(xhr.response).forEach(function (valor, indice) {
          ...
          if (permisos_plantel.primer_parcial === "1") {
            registro += '<td><input type="text" class="form-control" name="primer_parcial['+valor.no_control+']" value="' + (primer_parcial === "0" ? "/" : primer_parcial) + '" id="primer_parcial" onchange="calificaciones(this,\''+valor.tipo+'\',2,'+indice+','+permisos_plantel.examen_final+');"></td>';
          }
          else {
