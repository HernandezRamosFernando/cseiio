...
function primer_semestre($semestre,$materias_estudiantes,$html_pos_materias){        
    ...
    if($semestre=='1'){
        ...
        return '<tr style="font-size:4 pt;text-align:center"><td style="width:20px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>N/P</td><td style="width:40px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>MATRICULA</td><td style="width:100px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>CURP</td><td style="width:20px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>SEXO</td><td style="width:244px;background-color:#f8facb">NOMBRE DEL ALUMNO</td><td style="width:25px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>EDAD ACTUAL</td><td style="width:50px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>SITUACIÓN ALUMNO</td><td style="width:364px;background-color:#f8facb">(CLAVE-UNIDAD DE CONTENIDO)<br>CALIFICACIÓN</td><td style="width:40px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>SIT. ALUMNO FIN DEL MÓDULO</td><td style="width:180px;background-color:#f8facb">ANTES DEL PERIODO DE REGULARIZACIÓN</td><td style="width:220px;background-color:#f8facb">DESPUES DEL PERIODO DE REGULARIZACIÓN</td><td style="width:40px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>FECHA DE BAJA</td><td style="width:40px;background-color:#f8facb" rowspan="2"><br><br><br><br><br><br><br>FECHA DE NACIMIENTO</td> </tr>
