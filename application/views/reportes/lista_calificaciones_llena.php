...
$titulo = '<span style="text-align:center;font-size:8pt;  font-weight:bold">COLEGIO SUPERIOR PARA LA EDUCACION INTEGRAL INTERCULTURAL DE OAXACA</span><br>
...
function rellenar_lista($estudiantes,$bajas,$tipo_materia){
    ...
    foreach($estudiantes as $estudiante){
        ...
        if(sizeof($bajas[$contador-1])>0){
            ...
            $respuesta.='<td style="width:89px"></td></tr>';
        }
...
$pdf->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '24', $datos_cabecera, $border = 0, $ln = 1, $fill = 0, $reseth = false, $align = 'C', $autopadding = true);

$pdf->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '44', $encabezado_tabla, $border = 0, $ln = 1, $fill = 0, $reseth = false, $align = 'C', $autopadding = true);

$pdf->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '51', $datos_estudiantes, $border = 0, $ln = 1, $fill = 0, $reseth = false, $align = 'C', $autopadding = true);
...
$pdf->Output('Lista con calificaciones.pdf', 'I');
